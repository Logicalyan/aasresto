    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white">
        ...
        <ul class="space-y-2 transition-all ease-in-out duration-700">
            <li>
                ...
                <a href="" class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg hover:bg-blue-500 group">
                    ...
                    <span class="flex-1 ml-8 group-hover:text-white">User profile</span>
                </a>
                {{-- @endif --}}
            </li>
            <li>
