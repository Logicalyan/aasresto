                                        ...
                                        <form class="grid gap-4 sm:grid-cols-2 sm:gap-6" enctype="multipart/form-data"
                                            ...
                                            <div class="w-full">
                                                <label for="category_name"
                                                    class="block mb-2 text-sm font-medium text-gray-900">Nama Kategori</label>
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apa kamu yakin ingin menghapus kategori {{ $category->name }}</h3>
