...
@section('content')
    ...
    <form action="{{ route('order.store') }}" method="post">
        ...
        <div>
            <label for="paid_amount">Masukkan uang</label>
        ...
        <div>
            ...
            <input disabled class="border-none" type="text" name="total_price" value="{{ $items->sum('subtotal') }}">
        </div>
        <button class="bg-blue-500 text-white p-2" type="submit">Submit</button>
    </form>

</section> --}}

    <section class="bg-white py-8 antialiased md:py-24">
    ...
    @endif
        <form action="{{ route('order.store') }}" method="POST" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            @csrf
            <ol
            class="items-center gap-2 flex w-full max-w-2xl text-center text-sm font-medium text-gray-500 sm:text-base">
            <a href="{{ route('cart.index') }}" class="p-2 bg-blue-500 text-white rounded-lg" role="button">Kembali</a>
                <li
                    ...
                    <span
                        class="flex items-center text-blue-500 after:mx-2 after:text-blue-500 after:text-blue-500 after:content-['/'] sm:after:hidden">
                ...
                <li
                    ...
                    <span
                        class="flex items-center text-blue-500 after:mx-2 after:text-gray-200 after:content-['/'] sm:after:hidden">
                        <svg class="me-2 h-4 w-4 sm:h-5 sm:w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8.5 11.5 11 14l4-4m6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
            ...
            <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
                <div class="min-w-0 flex-1 space-y-8">
                    <div class="space-y-4">
                        <h2 class="text-xl font-semibold text-gray-900">Detail Pemesanan</h2>

                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label for="customer_name" class="mb-2 block text-sm font-medium text-gray-900">
                                    Nama Pembeli</label>
                                <input type="text" name="customer_name" id="customer_name"
                                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500"
                                    placeholder="Nadhif" required />
                            </div>

                            {{-- <div>
                                <label for="phone-input-3"
                                    class="mb-2 block text-sm font-medium text-gray-900"> Nomor Telp Pembeli
                                </label>
                                <div class="flex items-center">
                                    ...
                                    <div class="relative w-full">
                                        <input type="text" id="phone-input"
                                            class="z-20 block w-full rounded-e-lg border border-s-0 border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:border-s-gray-700  dark:placeholder:text-gray-400 dark:focus:border-primary-500"
                            ...
                            <div class="">
                                <div class="mb-2 flex items-center gap-2">
                                    <label for="select-table-input-3"
                                        class="block text-sm font-medium text-gray-900"> Pilih Meja </label>
                                </div>
                                <select id="select-table-input-3" name="table_id"
                                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500">
                            ...
                            {{-- <div>
                                <label for="phone-input-3"
                                    class="mb-2 block text-sm font-medium text-gray-900"> Phone Number*
                                </label>
                                <div class="flex items-center">
                                    <button id="dropdown-phone-button-3" data-dropdown-toggle="dropdown-phone-3"
                                        class="z-10 inline-flex shrink-0 items-center rounded-s-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100"
                            ...
                            {{-- <div>
                                <label for="company_name"
                                    class="mb-2 block text-sm font-medium text-gray-900"> Company name
                                </label>
                            ...
                            <div class="">
                                <label for="paid_amount"
                                    class="mb-2 block text-sm font-medium text-gray-900"> Uang Pembayaran
                                </label>
                            ...
                            <div class="col-span-2">
                                <label for="review"
                                    class="mb-2 block text-sm font-medium text-gray-900"> Ulasan
                                </label>
                                <input type="text" name="review" id="review"
                                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500"
                                    placeholder="Hebat, Cepat, Keren" required />
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ms-4 text-sm">
                                        <label for="credit-card"
                                            class="font-medium leading-none text-gray-900"> Credit Card
                                        </label>
                                        <p id="credit-card-text"
                                            class="mt-1 text-xs font-normal text-gray-500">Pay with your
                                            credit card</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ms-4 text-sm">
                                        ...
                                        <p id="pay-on-delivery-text"
                                            class="mt-1 text-xs font-normal text-gray-500">+$15 payment
                                            processing fee</p>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ms-4 text-sm">
                                        <label for="paypal-2"
                                            class="font-medium leading-none text-gray-900"> Paypal account
                                        </label>
                                        <p id="paypal-text"
                                            class="mt-1 text-xs font-normal text-gray-500">Connect to
                                            your account</p>
                                    </div>
                                </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                            <div
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ms-4 text-sm">
                                        <label for="dhl"
                                            class="font-medium leading-none text-gray-900"> $15 - DHL Fast
                                            Delivery </label>
                                        <p id="dhl-text"
                                            class="mt-1 text-xs font-normal text-gray-500">Get it by
                                            Tommorow</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ms-4 text-sm">
                                        <label for="fedex"
                                            class="font-medium leading-none text-gray-900"> Free Delivery -
                                            FedEx </label>
                                        <p id="fedex-text"
                                            class="mt-1 text-xs font-normal text-gray-500">Get it by
                            ...
                            <div
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ms-4 text-sm">
                                        <label for="express"
                                            class="font-medium leading-none text-gray-900"> $49 - Express
                                            Delivery </label>
                                        <p id="express-text"
                                            class="mt-1 text-xs font-normal text-gray-500">Get it today
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    {{-- <div>
                        <label for="voucher" class="mb-2 block text-sm font-medium text-gray-900"> Enter
                ...
                <div class="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
                    <div class="flow-root">
                        <div class="-my-3 divide-y divide-gray-200 dark:divide-gray-800">
                            <dl class="flex items-center justify-between gap-4 py-3">
                                ...
                                <dd class="text-base font-medium text-gray-900">Rp {{ number_format($items->sum('subtotal')) }}</dd>
                            </dl>
                            ...
                            <dl class="flex items-center justify-between gap-4 py-3">
                                <dt class="text-base font-normal text-gray-500">Pajak 10%</dt>
                                <dd class="text-base font-medium text-gray-900">$199</dd>
                            </dl>

                            <dl class="flex items-center justify-between gap-4 py-3">
                                <dt class="text-base font-bold text-gray-900">Total</dt>
                                <dd class="text-base font-bold text-gray-900">Rp {{ number_format($items->sum('subtotal')) }}</dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        <button type="submit"
                            class="flex w-full items-center justify-center rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300">Bayar sekarang</button>
                    </div>
                </div>
            </div>
        </form>
